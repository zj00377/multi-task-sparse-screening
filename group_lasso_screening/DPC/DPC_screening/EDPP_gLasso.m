function [Sol, ind_zgd, value] = EDPP_gLasso(X, y, Lambda, opts)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:npar
    ...
    if lambdac>=lambda_max
        ...
        [x1, fvalue, ~]= glLeastR(Xr, y, lambdac, opts);   
        value(Lambda_ind(i)) = fvalue(size(fvalue,1));
